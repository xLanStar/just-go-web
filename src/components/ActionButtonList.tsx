  ...
  return (
    <>
      ...
      {mode === "edit" && (
        <>
          <TripSettingDialog
            isOpen={isTripSettingDialogOpen}
            onClose={() => {
              setTripSettingDialogOpen(false);
            }}
          />
          <ShareSettingDialog
            isOpen={isShareSettingDialogOpen}
            onClose={() => {
              setShareSettingDialogOpen(false);
            }}
          />
          <Button
            className={className}
